...
[00FFFF]━━━━━━━━━━━━━━━━━━━━━━━━"""
        ...
        await safe_send_message(chat_type,
"[b][c][00FFFF] Hey User Welcome [00FFFF] To —͞ MARUF HASAN BOT",
                                sender_uid, chat_id, key, iv)
        await asyncio.sleep(0.5)
...
async def handle_praisa_command(inPuTMsG: str, sender_uid: int, chat_id: int, chat_type: int,
    ...
    messages = [
        ...
        "🏅 {Name} তুমি সত্যিকারের চ্যাম্পিয়ন! ( MARUF )"
    ]
...
async def send_love_with_emotes(name: str, uid: int, chat_id: int, chat_type: int, key: bytes, iv: bytes, region: str):
    ...
    messages = [
        ...
        "[B][C][FFFFFF]♡ [FF0000]{Name} চল দুজনে [FFFFFF]মিলে [00FFFF]বুইয়া নিই , তোমারি মারুফ [FFFFFF]♡"
    ]
...
async def clan_message_loop():
    ...
    try:
        ...
        if _clan_msg_clan_id and _clan_msg_clan_id > 0 and _clan_msg_key and _clan_msg_iv:
            clan_msg = "Hello everyone this is MARUF HASAN, VONDO CITY GUILD Bot thanks for using me . Every day i need 100 glory or you will be kicked directly ."
        ...
        while True:
            ...
            if _clan_msg_clan_id and _clan_msg_clan_id > 0 and _clan_msg_key and _clan_msg_iv:
                clan_msg = "Hello everyone this is MARUF HASAN, VONDO CITY GUILD Bot thanks for using me . Every day i need 500 glory or you will be kicked directly ."
                await safe_send_message(1, clan_msg, _clan_msg_bot_uid, _clan_msg_clan_id, _clan_msg_key, _clan_msg_iv)
...
async def black666(client_id, key, iv):
    banner_text = "[FF0000][B][C] ERROR , WELCOME TO [FFFFFF]MARUF HASAN [FFFF00]___X³____ BOT ! \n[FFFF00]NEW VERSION NEW FUNCTION !\n[FF0000]FACEBOOK : @MARUF HASAN\n\n"     
    fields = {
        1: 5,
        2: {
            1: int(client_id),
                    ...
                    if data_hex.startswith("0500"):
                        ...
                        if packet_json.get("1") == 25:
                            ...
                            if new_friend_uid:
                                ...
                                friend_msg = "hi this using MARUF -CODEX bot thanks for using me"
...
[b][ffdd00][c]◉━━━━━━━━━━━━━━◉
[FFDDAA]     স্বা🥰গত🥰ম MARUF HASAN এ💀র BOT এ
[b][ffdd00] 👽 BOT OWNER : [FFFFFF]MARUF HASAN
[DDDDDD]👽 TIKTOK USER👽NA👽ME : [55DDAA]@MARUFXGAMING10
[FF4400]👽 YouTube: [FFFFFF]@MARUF GAMING
...
📝 Examples:
/bio Hello World!
/bio 🤖 Bot by MARUF CODEX
/bio Level 70 | Pro Player
/bio Add me: MARUF HASAN
...
[b][c][A52A2A]FACEBOOK CONTACT MARUF HASAN
 
[C][B][0000FF]MARUF HASAN
"""
...
#GALI SPAM MESSAGE 
    ...
    "MARUF", "LEADER", "TAHMID", "TAHMID-CODEX",
                        ...
                        if original_msg and "StickerStr" in original_msg:
                            ...
                            if NUMBER_EMOTES:
                                ...
                                try:
                                    ...
                                    await SEndPacKeT(whisper_writer, online_writer, 'OnLine', H)
                                    # Also send a message
                                    sticker_reply = "[B][C][FFFF00] MARUF  STYLE TCP"
